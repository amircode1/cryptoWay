        ...
        {isLoading ? (
          ...
          <>
            ...
            <p className="text-sm md:text-base text-gray-500 px-4 pb-4 font-semibold">
              As of today, we track 216 crypto exchanges with a total 24h trading volume of $119
              Billion, a -28.83% change in the last 24 hours. Currently, the 3 largest cryptocurrency
              exchanges are Coinbase Exchange, OKX, and KuCoin. Total tracked crypto exchange
              reserves currently stand at $273 Billion.
            </p>
          </>
        )}
      </div>
