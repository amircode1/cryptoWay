    ...
    <div className="flex justify-start items-center flex-col min-w-7xl">
      ...
      <div className="w-full max-w-7xl mt-3 border-b-2 border-emerald-300">
        {isLoading ? (
          ...
          <>
            <h1 className="text-2xl md:text-3xl font-bold text-start p-4">Top Gainers</h1>
            <p className='text-sm md:text-base text-start p-4 pb-2 font-semibold text-gray-500'>
              Cryptocurrencies with the highest daily percentage change in price over the last 24 hours.
            </p>
          </>
        )}
      </div>

      <div className='flex flex-row flex-wrap gap-2 md:gap-4 justify-start items-start m-2 w-full max-w-7xl'>
